...
class Migration_Install_dm_policies_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'DM_Policies.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'DM_Policies.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'DM_Policies.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'DM_Policies.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
