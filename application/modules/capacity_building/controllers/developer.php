...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Capacity_Building.Developer.View');
	...
	{
		$this->auth->restrict('Capacity_Building.Developer.Create');
	...
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/capacity_building');
		}
