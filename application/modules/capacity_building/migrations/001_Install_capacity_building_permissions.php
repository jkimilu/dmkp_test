...
class Migration_Install_capacity_building_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Capacity_Building.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Capacity_Building.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Capacity_Building.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Capacity_Building.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
