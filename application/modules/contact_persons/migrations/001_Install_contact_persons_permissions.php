...
class Migration_Install_contact_persons_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Contact_Persons.Settings.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Contact_Persons.Settings.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Contact_Persons.Settings.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Contact_Persons.Settings.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
