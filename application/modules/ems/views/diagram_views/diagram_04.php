...
<ul class="nav nav-tabs diag_tabs">
    <li class="active"><a href="#note_h0" data-toggle="tab">Diagramme 4</a></li>
    <li><a href="#note_h1" data-toggle="tab">Note 1</a></li>
    <li><a href="#note_h2" data-toggle="tab">Note 2</a></li>
    <li><a href="#note_h3" data-toggle="tab">Note 3</a></li>
    <li><a href="#note_h4" data-toggle="tab">Note 4</a></li>
    <li><a href="#note_h5" data-toggle="tab">Note 5</a></li>
    <li><a href="#note_h6" data-toggle="tab">Note 6</a></li>
</ul>
...
<div class="tab-content tab-content-diagrams">
    ...
    <!-- tab-pane -->
    <div class="tab-pane active" id="note_h0">
        
        <div class="well well-small">
            Diagram 4 shows Boundary Conditions. Click the tabs at the top to learn more explore this diagramme further.
        </div>
        
        <?php echo img(base_url('themes/dmkp/img/diagrammes/Diagramme-4-0.jpg')); ?>
        
    </div>
    <!-- /tab-pane -->
    
    <!-- tab-pane -->
    <div class="tab-pane" id="note_h1">
        ...
        <?php echo img(base_url('themes/dmkp/img/diagrammes/Diagramme-4-1.jpg')); ?>
        
    </div>
    <!-- /tab-pane -->
    
    <!-- tab-pane -->
    <div class="tab-pane" id="note_h2">
        ...
        <?php echo img(base_url('themes/dmkp/img/diagrammes/Diagramme-4-2.jpg')); ?>
        
    </div>
    <!-- /tab-pane -->
    
    <!-- tab-pane -->
    <div class="tab-pane" id="note_h3">
        ...
        <?php echo img(base_url('themes/dmkp/img/diagrammes/Diagramme-4-3.jpg')); ?>
        
    </div>
    <!-- /tab-pane -->
    
    <!-- tab-pane -->
    <div class="tab-pane" id="note_h4">
        ...
        <?php echo img(base_url('themes/dmkp/img/diagrammes/Diagramme-4-4.jpg')); ?>
    ...
    <div class="tab-pane" id="note_h5">
        ...
        <?php echo img(base_url('themes/dmkp/img/diagrammes/Diagramme-4-5.jpg')); ?>
    ...
    <div class="tab-pane" id="note_h6">
        ...
        <?php echo img(base_url('themes/dmkp/img/diagrammes/Diagramme-4-6.jpg')); ?>
