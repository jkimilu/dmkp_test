                        ...
                        <?php foreach($tree_item_value[1] as $tree_sub_item_key => $tree_sub_item_value) : ?>
                            <?php if(!is_array($tree_sub_item_value[1])) : ?>
                                <div>
                                    ...
                                    <?php content_sub_tree($content_sub_trees, $main_array_index, $sub_array_index, $tree_item_value, $tree_sub_item_value, $tree_item_key, $tree_sub_item_key, $lang_items); ?>
                                </div>
                            <?php else : ?>
                                <div>
                                    ...
                                    <?php content_sub_tree($content_sub_trees, $main_array_index, $sub_array_index, $tree_item_value, $tree_sub_item_value[0], $tree_item_key, $tree_sub_item_key, $lang_items); ?>
                                </div>
                            <?php endif; ?>
                            <?php $sub_array_index++; ?>
                        <?php endforeach; ?>
