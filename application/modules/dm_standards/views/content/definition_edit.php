...
<?php echo form_open('admin/content/dm_standards/definition_save'); ?>
<input type="hidden" name="definition_id" value="<?php echo $definition_id; ?>">
<fieldset>
    <?php if($definition_id == 0) : ?>
        <legend><?php echo lang('dms_new_definition'); ?></legend>
    <?php else : ?>
        <legend><?php echo lang('dms_edit_definition'); ?></legend>
    <?php endif; ?>
    <p><input type="text" placeholder="<?php echo lang('dms_definition_title'); ?>" name="definition" value="<?php echo isset($definition->title) ?  $definition->title : ''; ?>"></p>
    <p>
