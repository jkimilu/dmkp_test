            ...
            <div class="modal-body container-fluid">
                ...
                <div class="row-fluid">
                    ...
                    <div class="controls controls-row">
                        <input name="full_name" class="span6" placeholder="Your Name" id="disabledInput" value="" type="text">
                        <input name="email_address" class="span6" placeholder="Your Email Address" value=""  type="text">
                    </div>
                </div>
                <!-- /.row-fluid -->
            </div>
