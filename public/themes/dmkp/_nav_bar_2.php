<div class="navbar2">
    ...
    <div class="max-width">
        <ul class="unstyled inline ul_navbar2">
            ...
            <!-- TODO: Temporarily only visible to admins: Remove constraint after approval -->
            ...
            <li <?php echo(isset($ems_active) ? 'class="active"' : ''); ?>><a data-original-title="Emergency Management Manual" href="<?php echo site_url('ems'); ?>" class="tipify" title="" data-placement="bottom"><i class="fa fa-book"></i> EMS Manual</a></li>
            <li <?php echo(isset($dm_preparedness_active) ? 'class="active"' : ''); ?>><a data-original-title="Disaster Management Preparedness" href="<?php echo site_url('dm_preparedness'); ?>" class="tipify" title="" data-placement="bottom"><i class="fa fa-umbrella"></i> DM Preparedness</a></li>
